    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card"> 
                ...
                @endif
                <form method="POST" action="{{ route('post.put.edit') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{ $Post->id }}">

                    <div class="form-group">
                        <label for="formGroupExampleInput">Titular</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Había una vez un título..." name="title" value="{{ $Post->title }}">
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" name="hash" id="hash" value="{{ $Post->hash }}">
